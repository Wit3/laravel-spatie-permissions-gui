    ...
    <div class="flex flex-wrap flex-1">
        ...
        <div class="flex-1 p-8 bg-white">
            <div class="items-end w-full pb-8">
                ...
                <p class="mb-4 text-sm font-light leading-5 text-gray-600">@lang("This page contains the available
                    permissions and user roles. You can create a new role, assign a permission to a role, and use that
