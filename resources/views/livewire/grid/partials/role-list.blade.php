<div class="relative whitespace-no-wrap min-w-full inline-block text-left w-full permission-ui-dropdown" x-data="{ open: false }"
    @keydown.window.escape="open = false" @click.away="open = false" @refresh-mappings.window="open = false">
    <div>
        ...
        <div class="rounded-md bg-white" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
            ...
            <div class="px-3 py-3">
                ...
                <div class="w-full mb-1">
                    <div class="text-xs">@lang("Role Name"): </div>
                ...
                <div class="w-full mb-1">
                    <button type="button" wire:click="updateRole" href="#" class="w-full rounded p-1 px-3 text-center text-white bg-blue-500
                            hover:bg-blue-700 focus:outline-none" role="menuitem" wire:loading.attr="disabled">@lang("Update Name")
                    </button>
                </div>
                <div class="w-full mb-1">
                    <button type="button" wire:click="allowAll" href="#" class="w-full rounded p-1 px-3 text-center text-white bg-green-500
                    hover:bg-green-700 focus:outline-none" role="menuitem" wire:loading.attr="disabled">@lang("Grant All Permissions")
                    </button>
                </div>
                <div class="w-full mb-1">
                    <button type="button" wire:click="disallowAll" href="#" class="w-full rounded p-1 px-3 text-center text-black bg-yellow-300
                    hover:bg-yellow-400 focus:outline-none" role="menuitem" wire:loading.attr="disabled">@lang("Revoke All Permissions")
                    </button>
                </div>
                <div class="w-full">
                    <button type="button" wire:click="deleteRole" href="#" class="w-full rounded p-1 px-3 text-center text-white bg-red-500
                    hover:bg-red-700 focus:outline-none" role="menuitem" wire:loading.attr="disabled">@lang("Delete Role")
                    </button>
                </div>
            </div>
        </div>
